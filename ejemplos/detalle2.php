...
$detalle=array();
$cabeceraConsulta = array('Factura','Linaje','Monto','Fecha Incio Cobro','Nomina','Cedula');
while ($fila = mysql_fetch_assoc($resultado)) {
    $cuerpoConsulta[]= array($fila['numero_factura'],$fila['cobrado_en'],$fila['total'],$fila['fecha_inicio_cobro'],$fila['nomina_procedencia'],$fila['documento_id']);
